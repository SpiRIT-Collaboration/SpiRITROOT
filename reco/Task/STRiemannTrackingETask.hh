#ifndef STRIEMANNTRACKINGETASK
#define STRIEMANNTRACKINGETASK
...
class STRiemannTrackingETask : public STRecoTask
{
  public:
    STRiemannTrackingETask();
    STRiemannTrackingETask(Bool_t persistence);
    ~STRiemannTrackingETask();
  ...
  private:
    ...
    TClonesArray *fRiemannHitArray = nullptr;
    TClonesArray *fPreTrackArray = nullptr;
  ...
  ClassDef(STRiemannTrackingETask, 1)
};
