...
{
  fSCLogger->Info(MESSAGE_ORIGIN,("Loading E-field solution from " + fEFieldFile + " for projectile " + fProj).c_str());
...
void STSpaceCharge::SetProjectile(const std::string& value){ fProj = value; }
