...
void geomSPiRIT_Ar()
{
  ...
  TGeoMedium *argon     = new TGeoMedium("argon"    ,1, new TGeoMaterial("argon"));
  ...
  */
  TGeoVolume* activeCenter  = gGeoManager -> MakeBox("activeCenter",argon,xActiveC/2,yActiveC/2,zActiveC/2);
  TGeoVolume* activeTop     = gGeoManager -> MakeBox("activeTop",   argon,xActiveC/2,yActiveC/2,rActiveCorner/2);
  TGeoVolume* activeBottom  = gGeoManager -> MakeBox("activeBottom",argon,xActiveC/2,yActiveC/2,rActiveCorner/2);
  TGeoVolume* activeRight   = gGeoManager -> MakeBox("activeRight", argon,rActiveCorner/2,yActiveC/2,zActiveC/2);
  TGeoVolume* activeLeft    = gGeoManager -> MakeBox("activeLeft",  argon,rActiveCorner/2,yActiveC/2,zActiveC/2);
  TGeoVolume* activeCorner1 = gGeoManager -> MakeTubs("activeCorner1",argon,0.,rActiveCorner,yActiveC/2,0,   90. );
  TGeoVolume* activeCorner2 = gGeoManager -> MakeTubs("activeCorner2",argon,0.,rActiveCorner,yActiveC/2,90., 180.);
  TGeoVolume* activeCorner3 = gGeoManager -> MakeTubs("activeCorner3",argon,0.,rActiveCorner,yActiveC/2,180.,270.);
  TGeoVolume* activeCorner4 = gGeoManager -> MakeTubs("activeCorner4",argon,0.,rActiveCorner,yActiveC/2,270.,360.);
...
//  active -> SetMedium(p10);
  ...
  */
  ...
  TString geoFileName = dir + "/geometry/geomSPiRIT_Ar.root";
