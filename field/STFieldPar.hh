/** STFieldPar.h
 **
 ** Parameter set for the Samurai magnetic field. For the runtime database.
 **/

#ifndef STFIELDPAR_H
#define STFIELDPAR_H 1
...
class STFieldPar : public FairParGenericSet
{
 public:

  /** Standard constructor  **/
  STFieldPar(const char* name, const char* title, const char* context);
