...
#ifndef STFIELDMAP_H
#define STFIELDMAP_H 1
#include "FairField.h"
//#include "FairLogger.h"

class TArrayD;
class STFieldMapData;
class STFieldPar;


class STFieldMap : public FairField {
...
public:
  ...
  STFieldMap(STFieldPar* fieldPar);
 ...
 protected:
  ...
  void SetField(const STFieldMapData* data);
