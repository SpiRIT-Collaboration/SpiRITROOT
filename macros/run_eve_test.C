void run_eve_test(TString name = "test") 
{
  // Name
  TString workDir    = gSystem -> Getenv("VMCWORKDIR");

  TString inputName  = "output.root";
  TString outputName = "output.eve.root";
  TString parName    = "param.dummy.root";
