 ...
 ** are copied to a STMCTrack array, which is stored in the output.
 **
...
class STStack : public FairGenericStack
{
  ...
  private:
    ...
    STStack(const STStack&);
    STStack& operator=(const STStack&);
