...
void PIDTestData(int runNum = 1634, int fMultiCut = 15, int fClustCut = 15, double fPOCACut = 20) {
    string spec = "136Xe";
    if(runNum < 1600) {
        targetZpos = -21.86;
        spec = "124Xe";
    ...
    auto filePath = TString::Format("./data_reduc/124Xe/run*.root", spec.c_str(), runNum);
    cout << filePath << endl;
    ...
    TString outFilePath = TString::Format("./data/pid_data/pid_211.root");
